...
/*
CREATE TABLE ac32007_rihardssilins.users (
	user varchar,
	email varchar,
	password varchar,
	subscribed varchar,
...
public class UserModel {
	...
	/**
	 * UserModel::subscribeToUser()
	 * All user list
	 * @param String user, UserStore us
	 * @return true
	 */
	...
	/**
	 * UserModel::isEmailTaken()
	 * Check if passed email is taken
	 * @param String email
	 ...
	 * Check if passed username is taken
	 * @param String username
	 * @return boolean result
	 */
