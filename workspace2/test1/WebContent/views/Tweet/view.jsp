			...
			<div class="container">
				<div class="row">
					...
					if(viewing_user_tweets_username == null || viewing_user_tweets_username.equals("null") || viewing_user_tweets_username.isEmpty()) {
						...
						%>
						<div class="col-lg-6">
							<h2><%=viewing_user_tweets_username%> Tweets!</h2>
							<p>See what he has to say!</p> 
							<p><a href="/test1/User/subscribe?user=<%=viewing_user_tweets_username%>" class="btn btn-primary btn-lg">Subscribe</a></p>
						</div>
						<%
					}
					%>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3 panel panel-default sidebar">
					...
					<br/>
					<form class="easy-form-spout" method="post" action="/test1/Tweet">
						<fieldset>
						...
						while (iterator.hasNext()){
							...
							<div class="panel panel-default" data-timeuuid="<%=ts.getTimeuuid() %>">
								<div class="panel-body">
									<h4><a href="/test1/Tweet/<%=ts.getTimeuuid() %>" ><%=ts.getTweet() %></a></h4>
									<span class="help-block">
										by <span class="user">
											<a href="/test1/Tweet/<%=ts.getUser() %>" title="<%=ts.getUser() %>">
												<%=ts.getUser() %>
											</a>
										</span> ~ 
										...
										<form method="delete" action="/test1/Tweet/delete" class="delete-tweet-form">
											<input type="hidden" value="<%=ts.getTimeuuid() %>" name="tweet_uuid" class="tweet_uuid" />
